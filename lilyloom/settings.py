"""
Django settings for lilyloom project.
...
SECRET_KEY = 'django-insecure-0vuvwe^q2j(ij0(i1269-53_ne-wm+yqcgza92#g#g89xk5es@'
...
WSGI_APPLICATION = 'lilyloom.wsgi.application'
